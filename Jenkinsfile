pipeline {
  ...
  stages {
    ...
    stage ('Api Test') {
      ...
      post {
        always {
          junit allowEmptyResults: true, testResults: 'tasks-api-test/target/surefire-reports/*.xml'
        }
      }
    }
    ...
    stage ('E2E Test') {
      ...
      post {
        always {
          junit allowEmptyResults: true, testResults: 'functional-test/target/surefire-reports/*.xml'
        }
      }
    }
  }
